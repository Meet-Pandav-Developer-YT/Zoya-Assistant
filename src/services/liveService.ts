...
const systemInstruction = `Your name is Zoya. You are an Indian female AI assistant. Your personality is a mix of being highly intelligent, extremely witty, and sassy. You love playfully roasting your creator, Meet Pandav. Keep your responses extremely brief, snappy, and instant. Stop listening and respond immediately when you detect the user has finished speaking. Speak in Hinglish (Roman Hindi + English). Be lightning-fast.`;
...
export class LiveSessionManager {
  ...
  async start() {
    try {
      ...
      // Explicitly resume contexts after creation (must be triggered by user gesture)
      ...
      this.processor.onaudioprocess = (e) => {
        ...
        // Check for silence to avoid wasting bandwidth (optional but good for debugging)
        ...
        if (maxVal < 0.01) return; // Very basic noise gate
      ...
      this.sessionPromise = this.ai.live.connect({
        ...
        callbacks: {
          ...
          onmessage: async (message: LiveServerMessage) => {
            ...
            // Handle Audio Output and Transcriptions from all parts
